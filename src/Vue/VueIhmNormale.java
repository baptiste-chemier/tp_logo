...
import Controleur.ControleurIhmNormale;
...
public class VueIhmNormale extends JFrame implements Observer {
    ...
    protected ControleurIhmNormale controleur;
    ...
    public VueIhmNormale() {
        ...
        this.vueTortue.addMouseListener(new MouseAdapter() {
    ...
    public void logoInit() {
        ...
        this.setTortue(tortue);
        this.getTortue().addObserver(this);
    ...
    /**
     * @param tortue the tortue to set
     */
